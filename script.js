...
</span></td><td><span class="length-badge ${jangdaneum ? 'length-' + jangdaneum : 'length-없음'}" data-length="${jangdaneum || '없음'}" title="클릭하여 ${jangdaneum || '없음'} 필터링">${jangdaneum || '없음'}

</span></td><td>${url ? `<a href="${url}" target="_blank" rel="noopener noreferrer" class="blog-link" aria-label="${huneum} 한자 상세 보기">보기</a>` : '<span style="color:#999;">-</span>'}
